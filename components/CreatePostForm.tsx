...
export default function CreatePostForm() {
    ...
    return (
        ...
        <div>
            <h1 className="text-center mt-8">Create a Post</h1>
            <form onSubmit={handleSubmit} action="">
                <input onChange={(e) => setTitle(e.target.value)} className="border rounded-sm text-md  w-full mt-4 items-center p-4" type="text" placeholder="Title" />
                <textarea onChange={(e) => setContent(e.target.value)} className="border rounded-sm text-md mt-4 w-full p-6" placeholder="Content"></textarea>
                <div >
                ...
                <select onChange={(e) => setSelectedCategory(e.target.value)} className="w-full border rounded-dm text-md mt-4 p-4">
                ...
                <button className=" btn primary-btn mt-4 w-full" type="submit">Create Post</button>
